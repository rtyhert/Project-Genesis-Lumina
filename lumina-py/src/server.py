...
import sys
sys.path.append(str(Path(__file__).parent.parent / "lumina-proto" / "src"))
sys.path.append(str(Path(__file__).parent.parent / "lumina-proto" / "build"))
...
class LuminaServer:
    ...
    def _setup_logging(self):
        ...
        logging.basicConfig(
            ...
            filename=cfg.get("file", "logs/lumina.log"),
